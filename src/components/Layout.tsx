      ...
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col">
          <header className="h-14 flex items-center border-b bg-card px-4 gap-4">
            ...
            <h2 className="text-sm font-semibold text-secondary flex-1"><h2 className="text-sm font-semibold text-secondary flex-1">Ghana Immigration Service — Amasaman Sector Command — Cybernet</h2></h2>
            <ThemeToggle />
            <NotificationBell />
          </header>
