...
const defaultFeatures: { name: string; access: Record<string, Access> }[] = [
  {
    name: "Dashboard",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "full", shift_leader: "full", deputy_supervisor: "full", deputy_shift_leader: "full", special_duties: "full", deputy: "full", front_desk: "full", staff: "full" },
  },
  {
    name: "Staff / Employees",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "dept", deputy_supervisor: "dept", deputy_shift_leader: "dept", special_duties: "view", deputy: "view", front_desk: "none", staff: "view" },
  },
  {
    name: "Staff Directory",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "full", shift_leader: "full", deputy_supervisor: "full", deputy_shift_leader: "full", special_duties: "full", deputy: "full", front_desk: "view", staff: "full" },
  },
  {
    name: "Departments",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "view", shift_leader: "view", deputy_supervisor: "view", deputy_shift_leader: "view", special_duties: "view", deputy: "view", front_desk: "none", staff: "view" },
  },
  {
    name: "Roles / Ranks",
    access: { admin: "full", oic: "full", "2ic": "view", supervisor: "view", shift_leader: "view", deputy_supervisor: "view", deputy_shift_leader: "view", special_duties: "view", deputy: "view", front_desk: "none", staff: "view" },
  },
  {
    name: "Attendance",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "dept", deputy_supervisor: "dept", deputy_shift_leader: "dept", special_duties: "own", deputy: "own", front_desk: "own", staff: "own" },
  },
  {
    name: "Leave Requests",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "dept", deputy_supervisor: "dept", deputy_shift_leader: "view", special_duties: "own", deputy: "own", front_desk: "own", staff: "own" },
  },
  {
    name: "Postings & Transfers",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "view", deputy_supervisor: "view", deputy_shift_leader: "view", special_duties: "own", deputy: "own", front_desk: "none", staff: "own" },
  },
  {
    name: "Duty Roster",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "view", deputy_supervisor: "dept", deputy_shift_leader: "dept", special_duties: "view", deputy: "view", front_desk: "view", staff: "own" },
  },
  {
    name: "Announcements",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "view", deputy_supervisor: "view", deputy_shift_leader: "view", special_duties: "view", deputy: "view", front_desk: "view", staff: "view" },
  },
  {
    name: "Compliance",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "view", deputy_supervisor: "view", deputy_shift_leader: "view", special_duties: "view", deputy: "view", front_desk: "none", staff: "own" },
  },
  {
    name: "Reports",
    access: { admin: "full", oic: "full", "2ic": "full", supervisor: "dept", shift_leader: "view", deputy_supervisor: "view", deputy_shift_leader: "view", special_duties: "none", deputy: "none", front_desk: "none", staff: "none" },
  },
  {
    name: "Front Desk",
    access: { admin: "full", oic: "full", "2ic": "view", supervisor: "view", shift_leader: "none", deputy_supervisor: "none", deputy_shift_leader: "none", special_duties: "none", deputy: "none", front_desk: "full", staff: "none" },
  },
  {
    name: "Settings / User Roles",
    access: { admin: "full", oic: "full", "2ic": "view", supervisor: "none", shift_leader: "none", deputy_supervisor: "none", deputy_shift_leader: "none", special_duties: "none", deputy: "none", front_desk: "none", staff: "none" },
  },
];
