...
export default function Interlink() {
  ...
  return (
    <div className="space-y-4 p-2 md:p-4">
      {/* Colorful header */}
      <div className="rounded-xl p-5 bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 text-white shadow-lg">
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="space-y-4">
        ...
        <Button
          size="lg"
          className="w-full bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 hover:opacity-90 text-white shadow-md"
