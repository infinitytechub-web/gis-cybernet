              ...
              <TableBody>
                ...
                : issuance.map((i: any) => (
                  <TableRow key={i.id}>
                    ...
                    <TableCell>{i.returned_at ? <Badge variant="secondary" className="bg-emerald-100 text-emerald-800">Returned {format(new Date(i.returned_at), "dd/MM/yyyy")}</Badge> : <Badge variant="outline">Active</Badge>}</TableCell>
