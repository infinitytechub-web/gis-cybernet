...
RETURNS TABLE(org_name text, system_label text, company_name text, logo_url text, favicon_url text, login_logo_url text, dashboard_logo_url text, primary_color text, secondary_color text, accent_color text, footer_text text, system_description text, header_text text, contact_email text, contact_phone text, contact_address text, contact_website text, login_tagline text, login_background_url text)
LANGUAGE sql
...
AS $function$
  SELECT
    ...
    a.login_tagline, a.login_background_url
