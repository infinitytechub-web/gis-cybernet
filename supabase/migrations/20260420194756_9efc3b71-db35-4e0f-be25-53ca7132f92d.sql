...
AS $$
  SELECT _table = ANY (ARRAY[
    'announcements','holidays','departments','staff_documents','command_vault_files',
    ...
    'postings_transfers','visa_applications','visa_extensions','passport_applications',
    'official_applications','enquiry_applications','front_desk_audit_log',
    'night_guard_activity_log','platform_sync_history'
  ]);
$$;